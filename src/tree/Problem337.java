...
public class Problem337 {
    ...
    // ①明确状态：对于每个节点，存在两种状态，被偷或者没有被偷
    // ②明确选择：对于被偷的节点，只有一个选择，不能偷它的左右子节点了；对于没有被偷的节点，它可以偷左子节点，也可以不偷左子节点，对于右子节点同理
    // ③明确dp数组的定义：dp[0]——在当前节点偷它时此时盗取到的最高金额，dp[1]——在当前节点不偷它时此时盗取到的最高金额
    // ④base case：对于空节点，偷或不偷都是0
